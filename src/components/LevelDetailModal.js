      ...
      <View style={s.container}>
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={[s.hero, { backgroundColor: level.colorBg }]}>
            ...
            <Text style={[s.heroSub, { color: level.color }]}>
          ...
          <View style={[s.examBanner, { backgroundColor: level.colorBg }]}>
            <Text style={[s.examBannerText, { color: level.color }]}>
              🎓 Готовит к: {level.targetExam}
            </Text>
          </View>
          ...
          <View style={s.progressCard}>
            ...
            <View style={s.statsRow}>
              ...
              <MiniStat
                icon="🎤"
                value={lp.interviewCompleted ? '✓' : '–'}
                label="Interview"
                color={lp.interviewCompleted ? T.green : T.sub}
              />
              <MiniStat
                icon="🏁"
                value={lp.gatePassed ? `${lp.gateScore}%` : '–'}
                label="Gate"
                color={lp.gatePassed ? T.green : T.sub}
              />
                ...
                <View key={module.id} style={s.moduleWrap}>
                  ...
                  >
                    <View style={s.moduleHeaderLeft}>
                      ...
                      <Text style={s.moduleContext} numberOfLines={1}>
                        {module.context}
                      </Text>
                    </View>
                    <View style={s.moduleRight}>
                      <Text style={[s.modulePct, { color: level.color }]}>
                          ...
                          >
                            <View
                              style={[
                                s.lessonDot,
                                {
                                  backgroundColor: done ? T.green : level.color + '44',
                                  borderColor: done ? T.green : level.color,
                                },
                              ]}
                            >
                            ...
                            <View style={s.lessonInfo}>
                              <Text style={[s.lessonTitle, done && { color: T.sub }]}>
                                {lesson.title}
                              </Text>
                              <Text style={s.lessonMeta}>
                                ⏱ {lesson.mins} мин · ⚡ +{lesson.xp} XP
                              </Text>
                            </View>
                            {done ? (
          ...
          <View style={s.section}>
            ...
            <TouchableOpacity
              style={[
                s.interviewCard,
                { borderColor: lp.interviewCompleted ? T.green : level.color },
              ]}
            ...
            >
              <View style={s.interviewTop}>
                <View style={[s.interviewBadge, { backgroundColor: level.colorBg }]}>
                  <Text style={[s.interviewBadgeText, { color: level.color }]}>
                    {level.interviewQuestion.source}
                  </Text>
                </View>
              ...
              <Text style={s.interviewQ} numberOfLines={3}>
              ...
              <View
                style={[
                  s.interviewBtn,
                  {
                    backgroundColor: lp.interviewCompleted ? T.greenBg : level.colorBg,
                    borderColor: lp.interviewCompleted ? T.green : level.color,
                  },
                ]}
              >
                <Text
                  style={[
                    s.interviewBtnText,
                    { color: lp.interviewCompleted ? T.green : level.color },
                  ]}
                >
          ...
          <View style={s.section}>
            ...
            <View
              style={[
                s.gateCard,
                { borderColor: lp.gatePassed ? T.gold : gateReady ? level.color : T.border },
              ]}
            >
              ...
              >
                <Text
                  style={[
                    s.gateBtnText,
                    { color: lp.gatePassed ? T.gold : gateReady ? '#000' : T.faint },
                  ]}
                >
                  {lp.gatePassed
